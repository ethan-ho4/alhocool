import './RiceAlcoholOverview.css';

export default function RiceAlcoholOverview() {
  return (
    <div className="rice-alcohol-overview-container">
        <p className="rice-alcohol-overview-title">The Ricey Revelations:</p>
        <p className="rice-alcohol-overview-content">In a realm where vast fields of golden grains swayed with the wind, a culinary conundrum arose: "How do we transform this humble grain into a drink fit for the gods?" And thus, rice-based alcohols were born, answering the universe's call for a silky-smooth sipper!<br/>
            <br/>   
