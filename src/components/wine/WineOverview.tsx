...
export default function WineOverview() {
  return (
    <div className="wine-overview-container">
        <p className="wine-overview-title">The Grand Wine Odyssey:</p>
        <p className="wine-overview-content">In epochs past, when civilizations were just beginning to touch the arts and sciences, a serendipitous discovery was made: wine. This wasn't just a drink; it was a symbol of culture, prosperity, and the joys of life itself.<br/>
            <br/>
