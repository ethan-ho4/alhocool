import './LiqueurOverview.css';

export default function LiqueurOverview() {
  return (
    <div className="liqueur-overview-container">
        <p className="liqueur-overview-title">The Luscious Liqueur Legend:</p>
        <p className="liqueur-overview-content">In a realm where spirits danced and wines serenaded, there emerged a question: "How do we craft a drink that's both spirited and sweet, a potion that tells tales of ancient herbs and luscious fruits?" And so, in this vibrant tapestry of beverages, liqueurs and cordials made their grand entrance!<br/>
            <br/>
            ...
            <br/>
            But the fruits had companions on this epic journey. Mystical herbs, plucked under moonlit nights, and exotic spices, traded from lands afar, joined the symphony. Together, they were steeped in spirits, absorbing their strength, yet softening their edges with sweetness. And then there was sugar – the sweet whisperer, ensuring every sip was a harmonious blend of strength and sweetness.<br/>
            <br/>
