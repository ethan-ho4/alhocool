import './LiqueurProcess.css';

export default function LiqueurProcess() {
  return (
    <div className="liqueur-process-container">
        <p className="liqueur-process-title">The Mystical Art of Liqueur Crafting:</p>
        <div className="liqueur-process-content">

            <p className="title-baileys">BAILEYS</p>
            <p className="content-baileys">Imagine the lush green fields of Ireland, where cows graze freely, producing the creamiest of milk. This milk, combined with rich Irish whiskey, forms the base of Baileys. Add a sprinkle of cocoa, a dash of vanilla, and a secret blend of ingredients, and you have a velvety drink that dances on your palate. Each sip is like a warm Irish hug, enveloping you in its creamy embrace. Sláinte! 🥃🍫🐄
                <br/><br/>    
            ...
            <p className="title-amaretto">AMARETTO</p>
            <p className="content-amaretto">Journey to the heart of Italy, where the sweetest of almonds meet the bitterest of apricot kernels. These are combined with pure alcohol, burnt sugar, and a blend of aromatic herbs. The outcome? Amaretto, a sweet, almond-flavored liqueur that whispers tales of Italian romance with every sip. Saluti! 🥂🌰💋
                <br/><br/>
